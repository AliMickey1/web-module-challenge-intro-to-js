...
*/
const conString = '1999';
console.log(Number(conString));
...
*/
const compRand = Math.random();
function compChoice(compRand) {
  if (compRand < 0.33) {
    return 'rock';
  } else if (compRand > 0.33 && compRand < 0.66) {
    return 'scissors';
  } else {
    return 'paper';
  }
...
const computer = compChoice(compRand);
